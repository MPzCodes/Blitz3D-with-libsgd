...
SetEnvTexture LoadCubeTexture("../../assets/envmaps/sunnysky-cube.png",TEXTURE_FORMAT_ANY,TEXTURE_FLAGS_DEFAULT)
...
Local heightTexture = Load2DTexture("../../assets/terrains/canyon/height.exr", TEXTURE_FORMAT_ANY, TEXTURE_FLAGS_DEFAULT)
Local normalTexture = Load2DTexture("../../assets/terrains/canyon/normal.png", TEXTURE_FORMAT_RGBA8, TEXTURE_FLAGS_DEFAULT)
Local albedoTexture = Load2DTexture("../../assets/terrains/canyon/albedo.png", TEXTURE_FORMAT_ANY, TEXTURE_FLAGS_DEFAULT)
